...
{
	public class GolemSentryItem : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<HiddenGolemSentry>();
		}
        ...
        public override bool AltFunctionUse(Player player)
		{
            ...
            {
				if (proj.owner == player.whoAmI && (proj.type == ModContent.ProjectileType<HiddenGolemSentry>() || proj.type == ModContent.ProjectileType<GolemSentry>()))
                {
					proj.Kill();
                }
            }
